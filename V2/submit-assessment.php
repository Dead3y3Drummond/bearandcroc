<?php
// Bear & Croc Equipment Health Check -> Resend
...
if (!$apiKey) {
    error_log('Bear & Croc assessment: RESEND_API_KEY is not configured.');
...
if (!$name || !$company || !$email) {
    ...
    echo json_encode(['ok' => false, 'error' => 'Name, company, and valid email are required']);
    exit;
}
